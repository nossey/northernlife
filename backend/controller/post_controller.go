...
// @Tags Posts
func (postControler *PostController) GetPosts(ctx *gin.Context) {
...
// @Router /posts/{id} [get]
// @Tags Posts
func (postControler *PostController) GetPost(ctx *gin.Context) {
	id := ctx.Param("id")
...
// @Security ApiKeyAuth
// @Tags Posts
func (postControler *PostController) CreatePost(ctx *gin.Context) {
...
// @Security ApiKeyAuth
// @Tags Posts
func (postControler *PostController) DeletePost(ctx *gin.Context) {
	claims := jwt.ExtractClaims(ctx)
	userID := claims[identityKey].(string)
	postID := ctx.Param("id")
